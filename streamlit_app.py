...
with tabs[1]:
    ...
    if selected_region:
        ...
        with col_radar_text:
            ...
            # 💡 수정 포인트: "점" -> "% 수준"으로 표현 변경
            st.info(f"""
            **💡 AI Insight**
            
            **{selected_region}** 지역은 전국 평균(100) 대비
            **'{strong_point}'** 지표가 **{max_val:.1f}% 수준**으로 가장 높습니다.
            (평균보다 약 {max_val - 100:.1f}% 더 높음)
            
            반면, **'{weak_point}'** 지표는 상대적으로 보완이 필요해 보입니다.
            """)
# ==============================
# 📌 TAB 3: 구직 경로
# ==============================
